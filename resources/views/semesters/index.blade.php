...
@section("content")
    <div class="container-fluid pt-5 pb-3 mb-5 bg-white">
        ...
        <div class="d-flex justify-content-between mb-3">
            <x-search-input placeholder="Search semester..." index-route="semesters.index" :hasFilter="false" />

            <div>
                <button data-toggle="modal" data-target="#add" class="btn btn-primary">Add Semester </button>
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-text btn-edit" data-toggle="modal" data-target="#edit"
                                    data-name="{{ $semester->name }}" data-id="{{ $semester->id }}">
                    ...
                    <tr>
                        <td colspan="6">
                            @if (count(Request::query()) > 0)
                                <x-empty-list index-route="semesters.index" />
                            @else
                                <div class="text-center py-5">
                                    <h6 class="font-weight-bold"> Semesters is Empty!</h6>
                                    <img width="200px" class="my-4 mx-auto d-block" src="{{ asset("img/products.svg") }}"
                                        alt="">
                                    <p>Currently no Semester Added.</p>
        ...
        <x-pagination-footer :collection="$semesters" />
    </div>
@endsection
@push("modal")
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body p-4 text-center">
                    ...
                    <p>Are you sure to delete this semester? This proccess cannot be undo.</p>
                </div>
                <div class="modal-footer border-0">
                    <form id="delete-form" class="w-100 d-flex justify-content-between"
                        action="{{ route("semesters.destroy", "") }}" method="POST">
                        @csrf
                        @method("DELETE")
    ...
    <div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form id="editform" action="{{ route("semesters.update", "") }}" method="POST">
                    @csrf
                    @method("PUT")
                    <div class="modal-header border-0">
