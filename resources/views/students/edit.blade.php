    ...
    <div class="container-fluid">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    @enderror"
                                            ...
                                            value="{{ old("id_number") ?? $student->id_number }}" min="1" required>
                                        @error("id_number")
                                    ...
                                    <div class="row">
                                        <div class="col-4">
                                            ...
                                            @enderror"
                                                    ...
                                                    value="{{ old("lname") ?? $student->user->lname }}" required>
                                                @error("lname")
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="col-4">
                                            ...
                                            @enderror"
                                                    ...
                                                    value="{{ old("fname") ?? $student->user->fname }}" required>
                                                @error("fname")
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="col-4">
                                            ...
                                            @enderror"
                                                    ...
                                                    value="{{ old("mname") ?? $student->user->mname }}" required>
                                                @error("mname")
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                    ...
                                    @enderror"
                                            ...
                                            value="{{ old("contact") ?? $student->user->contact }}" required>
                                        @error("contact")
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    @enderror"
                                            ...
                                            value="{{ old("address") ?? $student->user->address }}" min="1"
                                            required>
                                        @error("address")
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    @enderror"
                                            ...
                                            value="{{ old("email") ?? $student->user->email }}" min="1" required>
                                        @error("email")
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
        ...
        <div class="card">
            <form action="{{ route("students.update", $student) }}" method="POST">
                ...
                @method("PUT")
                <div class="card-header bg-white d-flex align-items-center py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Reset Student Password</h6>
                </div>
                <div class="card-body">
