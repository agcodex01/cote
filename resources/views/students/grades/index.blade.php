            ...
            <div class="row no-gutters align-items-end">
                <div class="col mr-2">
                    ...
                    <div class="text-md text-gray-800  text-uppercase mb-1">
                        <span class="font-weight-bold">Code:</span> BSIT
                    </div>
                    <div class="h6 mb-0 text-gray-800">
                        <span class="font-weight-bold">Description:</span>
                        Bachelor of Secondary Information and Technology
                    </div>
                </div>
                <div class="col-auto">
        ...
        <div class="card @if ($loop->first) mt-5 @else mt-3 @endif">
            <div class="card-header bg-white d-flex justify-content-between align-items-center py-3">
                <h6 class="m-0 font-weight-bold text-primary">{{ $class->yearLevel->name }} Year -
                    ...
                    <a href="{{ route('students.grades.print', ['student' => $student->id, 'year_level_id' => $class->year_level_id, 'semester_id' => $class->semester_id])}}" class="btn btn-primary">Print</a>
            </div>
            <div class="card-body">
                <table class="table">
                    <thead>
